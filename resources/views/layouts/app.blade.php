                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-5">
                        <div class="widgets_container widget_menu">
                            <a class="dg-widget-link" href="http://2gis.kz/almaty/profiles/70000001049032709,70000001047638630,70000001045157133/center/76.87957763671876,43.23344754501082/zoom/13?utm_medium=widget-source&utm_campaign=firmsonmap&utm_source=bigMap">Посмотреть на карте Алматы</a><script charset="utf-8" src="https://widgets.2gis.com/js/DGWidgetLoader.js"></script><script charset="utf-8">new DGWidgetLoader({"width":640,"height":600,"borderColor":"#a3a3a3","pos":{"lat":43.23344754501082,"lon":76.87957763671876,"zoom":13},"opt":{"city":"almaty"},"org":[{"id":"70000001049032709"},{"id":"70000001047638630"},{"id":"70000001045157133"}]});</script><noscript style="color:#c00;font-size:16px;font-weight:bold;">Виджет карты использует JavaScript. Включите его в настройках вашего браузера.</noscript>
                        </div>
                    </div>
                </div>
            </div>
		...
		function addToCart(that, product_id, quantity = 1){
			$.ajax({
				...
				success:function(res) {
                    ...
                    $('.mini_cart .cart_gallery').append('<div class="cart_item"><div class="cart_img"><a href="#"><img src="' + res.product.main_image.image + '" alt=""></a></div><div class="cart_info"><a href="#">' + res.product.name + '</a><p>1 x <span> ' + res.product.price + ' тг. </span></p></div><div class="cart_remove"><a href="#" onclick=\'removeCartItem(' + res.product.id + ')\'><i class="icon-x"></i></a></div></div>');
