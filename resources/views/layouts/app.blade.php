		...
		function addToCart(that, product_id, quantity = 1){
			$.ajax({
				...
				success:function(res) {
                    ...
                    $('.cart_gallery').append('<div class="cart_item"><div class="cart_img"><a href="#"><img src="' + res.product.main_image.image + '" alt=""></a></div><div class="cart_info"><a href="#">' + res.product.name + '</a><p>1 x <span> ' + res.product.price + ' тг. </span></p></div><div class="cart_remove"><a href="#" onclick=\'removeCartItem(' + res.product.id + ')\'><i class="icon-x"></i></a></div></div>');
